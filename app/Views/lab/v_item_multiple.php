                                            ...
                                            <div id="paket-container">
                                                <div class="paket-group border rounded p-2 mb-2">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="nama_paket_0" name="paket[0][nama_paket]" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="catatan_0" class="form-label">Deskripsi Paket</label>
                                                        <textarea class="form-control" id="catatan_0" name="paket[0][deskripsi]" rows="1"></textarea>
                                                    </div>
                                                    <button type="button" class="btn btn-danger btn-sm btn-remove-paket d-none">Hapus</button>
                                                </div>
                                            </div>
                                            <button type="button" class="btn btn-success btn-sm" id="btnAddPaket"><i class="fa fa-plus"></i> Tambah Paket</button>
                                        </div>
                                    ...
                                    <?php foreach ($paket as $p): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-primary act-bt btn-sm p-1" data-bs-toggle="modal" data-bs-target="#modalJenisTindakan<?= $p['id_paket']; ?>">
                                                    <i class="fa-solid fa-plus"></i>
                                                </button>
                                                <div class="modal fade" id="modalJenisTindakan<?= $p['id_paket']; ?>" tabindex="-1" aria-labelledby="modalJenisTindakanLabel<?= $p['id_paket']; ?>" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form action="<?= site_url('lab/saveJenisTindakan/' . $p['id_paket']); ?>" method="post">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="modalJenisTindakanLabel<?= $p['id_paket']; ?>">Paket <?=$p['nama_paket']?></h5>
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                <div class="modal-body">
                                                ...
                                                <a href="<?= site_url('lab/delete-lab/' . $p['id_paket']); ?>" class="btn btn-danger act-bt btn-sm p-1" onclick="return confirm('Yakin ingin menghapus paket ini?');">
